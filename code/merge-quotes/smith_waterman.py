...
def get_aligned_offsets(stringa,stringb,lang="tib"):
     ...
     if lang == "chn" or lang == "pli" or lang == "skt":
          ...
          if lang == "pli" or lang == "skt":
               ...
               alignments = pairwise2.align.localms(stringa_after,stringb_after,1,-2,-1.0,-0.5, gap_char=["-"],one_alignment_only=1)               
          if len(alignments) > 0:
               if len(alignments[0]) ==5 :
                    resulta,resultb,score,beg,end = alignments[0]
                    score = (score/abs(beg-end))
...
sanskrit_test_sentences = [
     ["ataś cāyam abhyupagamo na yuktikṣamo vijñānam api vijñeyavat saṃvṛtita eva na paramārthata iti | saṃvṛtito 'py abhāvaprasaṅgān na hi saṃvṛtir nirupādānā yujyate","ataḥ paramārthato 'sato yadi saṃvṛtāvapyasattvaṃ tadā saṃvṛtisatyasyaiva vināśaprasaṅgaḥ,"],
     ["pratibalāḥ svayamācāryakaṃ jñānaṃ paridīpayitumutpannotpannānāṃ ca parapravādināṃ","tasmād vinaiva bāhyenārthena vijñānaṃ sañcitākāram utpadyate | na ca paramāṇava eva saṃcitās tasyālambanaṃ paramāṇūnām atadākāratvāt |"],
     ["katham ity ata āha | yena yena vikalpena yad yad vastu vikalpyate | parikalpita evāsau svabhāvo na sa vidyate || 20","punarapi mahāmatirāha - yatpunaretaduktaṃ bhagavatā - yena yena vikalpena ye ye bhāvā vikalpyante, na hi sa teṣāṃ svabhāvo bhavati |"],
     ["VAkK_1.3 dharmāṇāṃ pravicayamantareṇa nāsti kleśānāṃ yata upaśāntaye 'bhyupāyaḥ |","VAkK_1.3 dharmāṇāṃ pravicayamantareṇa nāsti kleśānāṃ yata upaśāntaye 'bhyupāyaḥ | kleśaiśca bhramati bhavārṇave 'tra lokastaddhetorata uditaḥ kilaiṣa śāstrā ||"],
     ]
