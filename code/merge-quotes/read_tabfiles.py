...
#root_segtext_json, quotes = load_file("/mnt/output/pli/data/folder0/pli-tv-pvr1.1.txt_words.p",6,PALI_THRESHOLD,0)
#root_segtext_json, quotes = load_file("/mnt/output/tib/tab/folder0/T06D4021_words.p",7,0.02,0)
