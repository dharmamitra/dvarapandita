...
for i in /work/ftsx015/tib/data/folder*; do srun --time=11:59:00 --partition=std --mem=64gb  ~/anaconda3/bin/python calculate_quotes.py $i /work/ftsx015/tib/data/ tib & done
